(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["jstree"],{
...
!function (a) {
  "use strict";
   ...
   true ? !(__WEBPACK_AMD_DEFINE_ARRAY__ = [__webpack_require__(/*! jquery */ "xexB")], __WEBPACK_AMD_DEFINE_FACTORY__ = (a),
  ...
  if (!a.jstree) {
    ...
    !j && k && (j = function j(a, b) {
        ...
        if (null !== this.element) {
          ...
          var f = null,
            ...
            var c = a.dat,
              ...
              if (a && "object" == typeof a.state) for (f in a.state) {
                a.state.hasOwnProperty(f) && (m.state[f] = a.state[f]);
              }
              if (a && "object" == typeof a.li_attr) for (f in a.li_attr) {
                a.li_attr.hasOwnProperty(f) && (m.li_attr[f] = a.li_attr[f]);
              }
              if (m.li_attr.id || (m.li_attr.id = e), a && "object" == typeof a.a_attr) for (f in a.a_attr) {
                a.a_attr.hasOwnProperty(f) && (m.a_attr[f] = a.a_attr[f]);
              }

              for (a && a.children && a.children === !0 && (m.state.loaded = !1, m.children = [], m.children_d = []), l[m.id] = m, f = 0, h = m.children.length; h > f; f++) {
              ...
              if (o.li_attr.id && !o.id && (o.id = o.li_attr.id.toString()), o.id || (o.id = e), o.li_attr.id || (o.li_attr.id = o.id), a && "object" == typeof a.a_attr) for (f in a.a_attr) {
            ...
            if (c.length && c[0].id !== b && c[0].parent !== b) {
              ...
              for (p = 0, q = c.length; q > p; p++) {
                l[c[p].parent.toString()] ? (l[c[p].parent.toString()].children.push(c[p].id.toString()), m.children_d.push(c[p].id.toString())) : "undefined" != typeof h && (h._data.core.last_error = {
                  error: "parse",
                  plugin: "core",
                  id: "core_07",
              ...
              for (p = 0, q = c.length; q > p; p++) {
                o = t(c[p], d, m.parents.concat()), o && (e.push(o), f.push(o), l[o].children_d.length && (f = f.concat(l[o].children_d)));
              }
      ...
      _parse_model_from_flat_json: function _parse_model_from_flat_json(a, c, d) {
        ...
        if (a && "object" == typeof a.state) for (h in a.state) {
          a.state.hasOwnProperty(h) && (l.state[h] = a.state[h]);
        }
        if (a && "object" == typeof a.li_attr) for (h in a.li_attr) {
          a.li_attr.hasOwnProperty(h) && (l.li_attr[h] = a.li_attr[h]);
        }
        if (l.li_attr.id || (l.li_attr.id = e), a && "object" == typeof a.a_attr) for (h in a.a_attr) {
      ...
      _parse_model_from_json: function _parse_model_from_json(a, c, d) {
        ...
        if (l.li_attr.id && !l.id && (l.id = l.li_attr.id.toString()), l.id || (l.id = e), l.li_attr.id || (l.li_attr.id = l.id), a && "object" == typeof a.a_attr) for (f in a.a_attr) {
    ...
    l.className = "jstree-icon jstree-checkbox", l.setAttribute("role", "presentation"), a.jstree.defaults.checkbox = {
      ...
      this.bind = function () {
        d.bind.call(this), this._data.checkbox.uto = !1, this._data.checkbox.selected = [], this.settings.checkbox.three_state && (this.settings.checkbox.cascade = "up+down+undetermined"), this.element.on("init.jstree", a.proxy(function () {
          ...
          if (-1 !== j.indexOf("up") && -1 === l.indexOf(e.id)) {
            for (g = 0, h = e.parents.length; h > g; g++) {
              i = this._model.data[e.parents[g]], i.state[k ? "selected" : "checked"] = !1, i && i.original && i.original.state && i.original.state.undetermined && (i.original.state.undetermined = !1), i = this.get_node(e.parents[g], !0), i && i.length && i.attr("aria-selected", !1).children(".jstree-anchor").removeClass(k ? "jstree-clicked" : "jstree-checked");
            }
        ...
        for (d = 0, e = k.length; e > d; d++) {
          if (i[k[d]] && i[k[d]].parents) for (f = 0, g = i[k[d]].parents.length; g > f; f++) {
        ...
        for (this.element.find(".jstree-closed").not(":has(.jstree-children)").each(function () {
          ...
          if (c) if (c.state.loaded) {
            for (d = 0, e = c.children_d.length; e > d; d++) {
              if (j = i[c.children_d[d]], !j.state.loaded && j.original && j.original.state && j.original.state.undetermined && j.original.state.undetermined === !0) for (h[j.id] === b && j.id !== a.jstree.root && (h[j.id] = !0, l.push(j.id)), f = 0, g = j.parents.length; g > f; f++) {
                h[j.parents[f]] === b && j.parents[f] !== a.jstree.root && (h[j.parents[f]] = !0, l.push(j.parents[f]));
              }
            }
          } else if (c.original && c.original.state && c.original.state.undetermined && c.original.state.undetermined === !0) for (h[c.id] === b && c.id !== a.jstree.root && (h[c.id] = !0, l.push(c.id)), f = 0, g = c.parents.length; g > f; f++) {
            h[c.parents[f]] === b && c.parents[f] !== a.jstree.root && (h[c.parents[f]] = !0, l.push(c.parents[f]));
          }
        }), d = 0, e = l.length; e > d; d++) {
      ...
      this.init = function (a, b) {
        ...
        if (!e) {
          for (j = 0, k = b.length; k > j; j++) {
            (!i[b[j]] || !i[b[j]].state.loaded && !i[b[j]].state.failed || f) && (h.push(b[j]), l = this.get_node(b[j], !0), l && l.length && l.addClass("jstree-loading").attr("aria-busy", !0));
          }
      ...
      this.init = function (c, e) {
        ...
        this.element.on("model.jstree", a.proxy(function (c, d) {
          ...
          for (h = 0, i = f.length; i > h; h++) {
            ...
            if (g[j].a_attr !== b && "object" == typeof g[j].a_attr) for (k in g[j].a_attr) {
        ...
        if (l = this.get_node(c, !0), l && l.length && (m = l.children(".jstree-anchor")), i = c.type, j = this.get_icon(c), c.type = d, (j === !0 || !f[i] || f[i].icon !== b && j === f[i].icon) && this.set_icon(c, f[d].icon !== b ? f[d].icon : !0), f[i] && f[i].li_attr !== b && "object" == typeof f[i].li_attr) for (k in f[i].li_attr) {
        ...
        if (f[i] && f[i].a_attr !== b && "object" == typeof f[i].a_attr) for (k in f[i].a_attr) {
        ...
        if (f[d].li_attr !== b && "object" == typeof f[d].li_attr) for (k in f[d].li_attr) {
        ...
        if (f[d].a_attr !== b && "object" == typeof f[d].a_attr) for (k in f[d].a_attr) {
