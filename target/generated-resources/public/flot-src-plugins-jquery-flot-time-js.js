(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["flot-src-plugins-jquery-flot-time-js"],{
...
(function ($) {
  ...
  baseSpec = [[1, "second"], [2, "second"], [5, "second"], [10, "second"], [30, "second"], [1, "minute"], [2, "minute"], [5, "minute"], [10, "minute"], [30, "minute"], [1, "hour"], [2, "hour"], [4, "hour"], [8, "hour"], [12, "hour"], [1, "day"], [2, "day"], [3, "day"], [0.25, "month"], [0.5, "month"], [1, "month"], [2, "month"]],
      // we don't know which variant(s) we'll need yet, but generating both is
  // cheap
  specMonths = baseSpec.concat([[3, "month"], [6, "month"], [1, "year"]]),
      specQuarters = baseSpec.concat([[1, "quarter"], [2, "quarter"], [1, "year"]]);
      ...
      $.each(plot.getAxes(), function (axisName, axis) {
        ...
        if (opts.mode === "time") {
          axis.tickGenerator = function (axis) {
            ...
            spec = opts.tickSize && opts.tickSize[1] === "quarter" || opts.minTickSize && opts.minTickSize[1] === "quarter" ? specQuarters : specMonths;
...
//# sourceMappingURL=flot-src-plugins-jquery-flot-time-js.js.map