(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["flot-src-plugins-jquery-flot-selection-js"],{
...
(function ($) {
  function init(plot) {
    ...
    function onMouseMove(e) {
      if (selection.active) {
        updateSelection(e);
        plot.getPlaceholder().trigger("plotselecting", [getSelection()]); // prevent the default action if it is a 'touch' action
    ...
    function onMouseDown(e) {
      ...
      } else if (e.which !== 1 || e.originalEvent.touches && e.originalEvent.touches.length > 1) {
...
//# sourceMappingURL=flot-src-plugins-jquery-flot-selection-js.js.map