(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["flot-src-plugins-jquery-flot-pie-js"],{
...
(function ($) {
  ...
  function init(plot) {
    ...
    highlights = []; // add hook to determine if pie plugin in enabled, and then perform necessary operations
    ...
    function combine(data) {
      ...
      for (i = 0; i < data.length; ++i) {
        ...
        if (numCombined < 2 || value / total > options.series.pie.combine.threshold) {
          newdata.push( // Use extend rather than replacing, so other original
    ...
    function draw(plot, newCtx) {
      ...
      function drawPie() {
        var startAngle = Math.PI * options.series.pie.startAngle,
            radius = options.series.pie.radius > 1 ? options.series.pie.radius : maxRadius * options.series.pie.radius,
            i; // center and rotate to starting position
...
//# sourceMappingURL=flot-src-plugins-jquery-flot-pie-js.js.map